...
uses
  ...
  FireDAC.Comp.DataSet, Vcl.Mask, Vcl.DBCtrls, Vcl.Buttons, Data.FMTBcd,
  Data.SqlExpr;
...
type
  Tfrm_clientes = class(TForm)
    ...
    QryClientesNM_Cidade: TStringField;
...
procedure Tfrm_clientes.WMSysCommand(var Msg: TWMSysCommand);
begin
